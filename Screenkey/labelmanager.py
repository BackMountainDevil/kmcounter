...
REPLACE_SYMS = {
    ...
    'KP_1':         KeyRepl(False, False, True,  _('(1)')),
    'KP_2':         KeyRepl(False, False, True,  _('(2)')),
    'KP_3':         KeyRepl(False, False, True,  _('(3)')),
    'KP_4':         KeyRepl(False, False, True,  _('(4)')),
    'KP_5':         KeyRepl(False, False, True,  _('(5)')),
    'KP_6':         KeyRepl(False, False, True,  _('(6)')),
    'KP_7':         KeyRepl(False, False, True,  _('(7)')),
    'KP_8':         KeyRepl(False, False, True,  _('(8)')),
    'KP_9':         KeyRepl(False, False, True,  _('(9)')),
    'KP_0':         KeyRepl(False, False, True,  _('(0)')),
